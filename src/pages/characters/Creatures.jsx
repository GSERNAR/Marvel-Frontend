...
const Creatures = () => {
  ...
  return (
    <div>
      ...
      <Paragraph>
        As the OOA you will control the different NPCs and creatures
        that your players may encounter through their adventure.
        Here are some remarkable creatures and enemies you can use in
        your adventure.
      ...
      >
        {filteredCharacters
          .filter((character) => character.types.includes("minion")) // Filtra solo los que tienen "Hero"
